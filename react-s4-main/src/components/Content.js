...
const Content = ({ searchQuery }) => {
    ...
    const generateICS = (event) => {
        ...
        const dtstart = format(new Date(event.date.split(".").reverse().join("-")), "yyyyMMdd'T'HHmmss'Z'");
        const dtend = format(new Date(event.date.split(".").reverse().join("-")), "yyyyMMdd'T'HHmmss'Z'");
